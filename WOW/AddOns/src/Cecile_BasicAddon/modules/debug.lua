...
mod.Options = {
	...
	args = {
		...
		debug = {
			...
			get = function()			
				return Engine.Profile.debug.output;
			end,
			set = function(key, value)
				...
				Engine.Profile.debug.output = value;
			end,
		},
	}
...
function mod:OnInitialize()
	...
	if(Engine.Profile.debug.output) then
...
function mod.OnProfileChanged(event)
	...
	mod:EnableDebugging(Engine.Profile.debug.output);
	mod:Show(Engine.Profile.debug.output);
